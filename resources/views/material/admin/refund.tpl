...
<div class="page-wrapper">
    <div class="container-xl">
        <div class="page-header d-print-none text-white">
            <div class="row align-items-center">
                <div class="col">
                    <h2 class="page-title">
                        <span class="home-title">退款预览</span>
                    </h2>
                    <div class="page-pretitle">
                        <span class="home-subtitle">预览退款前后的账户内容变化</span>
                    </div>
                </div>
                <div class="col-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <a href="#" class="btn btn-primary d-none d-sm-inline-block" data-bs-toggle="modal"
                            data-bs-target="#notice-dialog">
                        ...
                        <a href="#" class="btn btn-primary d-sm-none btn-icon" data-bs-toggle="modal"
                            data-bs-target="#notice-dialog" aria-label="Create new report">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-receipt-refund"
                                width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"
                                fill="none" stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
        ...
        <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body text-center py-4">
                    ...
                    <p id="notice-message" class="text-muted">
                        确定要为此订单退款么，此操作仅还原列表中的内容，款项仍需手动返还给用户。操作无法撤销
                    </p>
                </div>
                <div class="modal-footer">
    ...
    <script>
        $("#notice-confirm").click(function() {
            $.ajax({
                url: '/admin/order/refund/{$order->no}',
                type: 'POST',
                dataType: "json",
